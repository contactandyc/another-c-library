...
On a mac, Command-F to get find and replace to show up on the bottom.  Next, select the <b>\.\*</b> option on the right side of the find and replace pane.  Replace dollar (<b>$</b>) with a space followed by a backslash (<b> \\</b>).
