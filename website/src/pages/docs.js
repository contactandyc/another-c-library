    ...
    <Layout>
      ...
      <div className="Tutorial-mn">
        <div className="Tutorial-cntnt Content">
          <h1 size="2xl" m="20px auto">Documentation</h1>
          <p>There are 14 documented modules released under the beta version.<br />
          To get started, clone the library:</p>
          <pre style={{ padding: `16px` }}>git clone https://github.com/contactandyc/another-c-library.git</pre>
          <p>Feel free to remove the website directory. To see the library in action, switch to the demo directory and run make:</p>
          <pre style={{ padding: `16px` }}>cd another-c-library/demo<br />
          make<br /></pre>
          <p>The package depends on libuv in the uvdemo directory. Use the following command to install libuv:</p>
          <pre style={{ padding: `16px` }}>brew install libuv<br />
          cd another-c-library/uvdemo<br />
          make<br />
          </pre>
          <p>Documentation, tests, and demonstrations are being written. Check out our Tutorial
