...
ac_in_t *ac_in_ext_init(ac_io_compare_f compare, void *arg,
                        ac_in_options_t *options);
```
ac_in_ext_init creates an ac_in_t object which can be added to via ac_in_ext_add to setup a multiple stream input.

## ac_in_init_from_list
...
```
ac_in_current returns the current record (this will be NULL if advance hasn't been called or
...
## ac_in_options_allow_partial_records
...
## ac_in_options_abort_on_partial
...
## ac_in_options_abort_on_file_not_found
...
## ac_in_options_abort_on_file_empty
...
## ac_in_options_compressed_buffer_size
...
<NextPrev prev="ac_conv" prevUrl="/docs/ac-conv" next="ac_json" nextUrl="/docs/ac-json" />
