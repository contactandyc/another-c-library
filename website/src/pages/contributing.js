  ...
  return (
    <Layout>
      ...
      <div className="Content-basic">
        <h1>Contributing</h1>
        <p>
          Another C Library is under very active development. Our hope is that
          others will contribute! While we are in the early stages of library
          creation, please feel free to <Link to="/contact">contact</Link> the
          project creators or open a pull request!
        </p>
        <h2>Project setup</h2>
        <ol>
        ...
        <pre style={{ padding: `16px` }}>
          git remote add upstream https://github.com/andycurtis/another-c-library.git<br />
        ...
        <p><strong>
          By contributing to Another C Library, you agree that your
          contributions will be licensed under its Apache License.
        </strong></p>
      </div>
    </Layout>
  );
