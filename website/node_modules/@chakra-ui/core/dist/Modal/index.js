...
function useAriaHider(_ref) {
  var isOpen = _ref.isOpen,
      ...
      container = _ref$container === void 0 ? _exenv.canUseDOM ? document.body : null : _ref$container;
  var mountRef = (0, _react.useRef)(_exenv.canUseDOM ? document.getElementById(id) || document.createElement("div") : null);
  (0, _react.useEffect)(function () {
    var undoAriaHidden = null;
    var mountNode = mountRef.current;

    if (isOpen && _exenv.canUseDOM) {
...
var Modal = function Modal(_ref2) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (isOpen && !closeOnOverlayClick) {
      _exenv.canUseDOM && document.addEventListener("keydown", func);
    }

    return function () {
      _exenv.canUseDOM && document.removeEventListener("keydown", func);
    };
