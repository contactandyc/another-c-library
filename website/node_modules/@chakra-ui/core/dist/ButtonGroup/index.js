...
var ButtonGroup = function ButtonGroup(_ref) {
  var size = _ref.size,
      ...
      rest = (0, _objectWithoutPropertiesLoose2["default"])(_ref, ["size", "variantColor", "variant", "isAttached", "spacing", "children"]);

  var clones = _react.Children.map(children, function (child, index) {
    if (!(0, _react.isValidElement)(child)) return;
    var isFirst = index === 0;
    var isLast = index === _react.Children.count(children) - 1;
