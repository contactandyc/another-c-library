...
1. define quicksort_name to be the name of your method
2. define quicksort_type to match your type
3. define quicksort_print_type as a print function to print your type along
  with the spacing (comma, newline, tab, etc) that separates elements.
4.  optionally define quicksort_less to be a function taking three arguments,
  where the third argument can be ignored if referencing an actual function
  with two parameters.  The function should return 0 for >= and non-zero for <.
  If you wish to sort descending, simply return 0 for <= and non-zero for >.
5.  optionally define quicksort_arg if you wish your comparison function to
  have an argument.  The quicksort function will also require an arg as the
  last parameter.
6.  #include "template/stla_quicksort.h"

Once you include stla_quicksort.h, it will undefine all of the parameters
defined in 1-5.  This allows you to create additional sort methods.

#define quicksort_type size_t
#define quicksort_print_type(x) printf("%lu ", x)
...
#include "template/stla_quicksort.h"
*/
