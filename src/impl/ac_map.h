...
#define ac_map_find_compare_arg_def(name, keytype, datatype)                 \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
...
#define ac_map_insert_compare_arg_def(name, datatype)                        \
  bool name(datatype *node, ac_map_t **root,                                 \
...
#define ac_map_find2_m(name, keytype, datatype, mapname, compare)            \
  datatype *name(const keytype *p, const ac_map_t *root) {                   \
    while (root) {                                                             \
...
#define ac_map_find2_arg_m(name, keytype, datatype, mapname, compare)        \
  datatype *name(const keytype *p, const ac_map_t *root, void *arg) {        \
    while (root) {                                                             \
      datatype *d = ac_parent_object(root, datatype, mapname);               \
...
#define ac_map_find_compare_arg_m(name, keytype, datatype)                   \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_find2_compare_arg_m(name, keytype, mapname, datatype)         \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_least2_m(name, keytype, datatype, mapname, compare)           \
  datatype *name(const keytype *p, const ac_map_t *root) {                   \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_least2_arg_m(name, keytype, datatype, mapname, compare)       \
  datatype *name(const keytype *p, const ac_map_t *root, void *arg) {        \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_least_compare_arg_m(name, keytype, datatype)                  \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_least2_compare_arg_m(name, keytype, datatype, mapname)        \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_greatest2_m(name, keytype, datatype, mapname, compare)        \
  datatype *name(const keytype *p, const ac_map_t *root) {                   \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_greatest2_arg_m(name, keytype, datatype, mapname, compare)    \
  datatype *name(const keytype *p, const ac_map_t *root, void *arg) {        \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_greatest_compare_arg_m(name, keytype, datatype)               \
  datatype *name(const keytype *p, const ac_map_t *root,                     \
...
#define ac_map_greatest2_compare_arg_m(name, keytype, datatype, mapname)     \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_lower_bound2_m(name, keytype, datatype, mapname, compare)     \
  datatype *name(const keytype *p, const ac_map_t *root) {                   \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_lower_bound2_arg_m(name, keytype, datatype, mapname, compare) \
  datatype *name(const keytype *p, const ac_map_t *root, void *arg) {        \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_lower_bound_compare_arg_m(name, keytype, datatype)            \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_lower_bound2_compare_arg_m(name, keytype, datatype, mapname)  \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_upper_bound2_m(name, keytype, datatype, mapname, compare)     \
  datatype *name(const keytype *p, const ac_map_t *root) {                   \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_upper_bound2_arg_m(name, keytype, datatype, mapname, compare) \
  datatype *name(const keytype *p, const ac_map_t *root, void *arg) {        \
    int n = 0;                                                                 \
    datatype *res = NULL;                                                      \
    while (root) {                                                             \
...
#define ac_map_upper_bound_compare_arg_m(name, keytype, datatype)            \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_upper_bound2_compare_arg_m(name, keytype, datatype, mapname)  \
  datatype *name(                                                              \
      const keytype *p, const ac_map_t *root,                                \
      int compare(const keytype *key, const datatype *value, void *arg),       \
      void *arg) {                                                             \
...
#define ac_map_insert2_m(name, datatype, mapname, compare)                   \
  bool name(datatype *node, ac_map_t **root) {                               \
    ac_map_t **np = root, *parent = NULL;                                    \
    while (*np) {                                                              \
      parent = *np;                                                            \
...
#define ac_map_insert2_arg_m(name, datatype, mapname, compare)               \
  bool name(datatype *node, ac_map_t **root, void *arg) {                    \
    ac_map_t **np = root, *parent = NULL;                                    \
    while (*np) {                                                              \
      parent = *np;                                                            \
...
#define ac_map_insert2_compare_m(name, datatype)                             \
  bool name(datatype *node, ac_map_t **root,                                 \
            int compare(datatype *key, datatype *value)) {                     \
    ac_map_t **np = root, *parent = NULL;                                    \
    while (*np) {                                                              \
...
#define ac_map_insert_compare_arg_m(name, datatype)                          \
  bool name(datatype *node, ac_map_t **root,                                 \
            int compare(datatype *key, datatype *value, void *arg),            \
            void *arg) {                                                       \
    ac_map_t **np = root, *parent = NULL;                                    \
...
#define ac_map_insert2_compare_arg_m(name, datatype)                         \
  bool name(datatype *node, ac_map_t **root,                                 \
            int compare(datatype *key, datatype *value, void *arg),            \
            void *arg) {                                                       \
    ac_map_t **np = root, *parent = NULL;                                    \
...
#define ac_multimap_insert2_m(name, datatype, mapname, compare)              \
  bool name(datatype *node, ac_map_t **root) {                               \
    ac_map_t **np = root, *parent = NULL;                                    \
    while (*np) {                                                              \
      parent = *np;                                                            \
...
#define ac_multimap_insert2_arg_m(name, datatype, mapname, compare)          \
  bool name(datatype *node, ac_map_t **root, void *arg) {                    \
    ac_map_t **np = root, *parent = NULL;                                    \
    while (*np) {                                                              \
      parent = *np;                                                            \
...
#define ac_multimap_insert_compare_arg_m(name, datatype)                     \
  bool name(datatype *node, ac_map_t **root,                                 \
            int compare(datatype *key, datatype *value, void *arg),            \
            void *arg) {                                                       \
    ac_map_t **np = root, *parent = NULL;                                    \
...
#define ac_multimap_insert2_compare_arg_m(name, datatype, mapname)           \
  bool name(datatype *node, ac_map_t **root,                                 \
            int compare(datatype *key, datatype *value, void *arg),            \
            void *arg) {                                                       \
    ac_map_t **np = root, *parent = NULL;                                    \
