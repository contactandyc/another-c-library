...
#define acsort_print_arg_m(name, datatype)                                  \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el, void *arg), void *arg) {      \
    if (func_line)                                                             \
      printf("%s ", func_line);                                                \
...
#define acsort_test_def(name, datatype)                                     \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el));

#define acsort_test_arg_def(name, datatype)                                 \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el, void *arg), void *arg);

#define acsort_test_less_def(name, datatype)                                \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b),                          \
            void (*print_element)(datatype * el));

#define acsort_test_less_arg_def(name, datatype)                            \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b, void *arg),               \
            void (*print_element)(datatype * el, void *arg), void *arg);

#define acsort_test_m(name, less, datatype)                                 \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el)) {                            \
    datatype *ep = base + num_elements;                                        \
    base++;                                                                    \
...
#define acsort_test_arg_m(name, less, datatype)                             \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el, void *arg), void *arg) {      \
    datatype *ep = base + num_elements;                                        \
    base++;                                                                    \
...
#define acsort_test_less_m(name, datatype)                                  \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b),                          \
            void (*print_element)(datatype * el)) {                            \
    datatype *ep = base + num_elements;                                        \
...
#define acsort_test_less_arg_m(name, datatype)                              \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b, void *arg),               \
            void (*print_element)(datatype * el, void *arg), void *arg) {      \
    datatype *ep = base + num_elements;                                        \
...
#define acsort_def(name, type) void name(type *base, size_t num_elements);

#define acsort_arg_def(name, type)                                          \
  void name(type *base, size_t num_elements, void *arg);

#define acsort_less_def(name, type)                                         \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b));

#define acsort_less_arg_def(name, type)                                     \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b, void *arg), void *arg);

#define acsort_m(name, type, less)                                          \
  void name(type *base, size_t num_elements) {                                 \
    type *a;                                                                   \
    type *b;                                                                   \
    type *c;                                                                   \
...
#define acsort_arg_m(name, type, less)                                      \
  void name(type *base, size_t num_elements, void *arg) {                      \
    type *a;                                                                   \
    type *b;                                                                   \
    type *c;                                                                   \
...
#define acsort_less_m(name, type)                                           \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b)) {                        \
    type *a;                                                                   \
    type *b;                                                                   \
...
#define acsort_less_arg_m(name, type)                                       \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b, void *arg), void *arg) {  \
    type *a;                                                                   \
    type *b;                                                                   \
