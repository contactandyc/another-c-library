...
#define ac_sort_test_less_def(name, datatype)                                \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b),                          \
            void (*print_element)(datatype * el));

#define ac_sort_test_less_arg_def(name, datatype)                            \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b, void *arg),               \
            void (*print_element)(datatype * el, void *arg), void *arg);

#define ac_sort_test_m(name, less, datatype)                                 \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el)) {                            \
    datatype *ep = base + num_elements;                                        \
    base++;                                                                    \
...
#define ac_sort_test_arg_m(name, less, datatype)                             \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            void (*print_element)(datatype * el, void *arg), void *arg) {      \
    datatype *ep = base + num_elements;                                        \
    base++;                                                                    \
...
#define ac_sort_test_less_m(name, datatype)                                  \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b),                          \
            void (*print_element)(datatype * el)) {                            \
    datatype *ep = base + num_elements;                                        \
...
#define ac_sort_test_less_arg_m(name, datatype)                              \
  void name(char *func_line, datatype *base, ssize_t num_elements,             \
            bool (*less)(datatype * a, datatype * b, void *arg),               \
            void (*print_element)(datatype * el, void *arg), void *arg) {      \
    datatype *ep = base + num_elements;                                        \
...
#define ac_sort_less_def(name, type)                                         \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b));

#define ac_sort_less_arg_def(name, type)                                     \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b, void *arg), void *arg);

#define ac_sort_m(name, type, less)                                          \
  void name(type *base, size_t num_elements) {                                 \
    type *a;                                                                   \
    type *b;                                                                   \
    type *c;                                                                   \
...
#define ac_sort_arg_m(name, type, less)                                      \
  void name(type *base, size_t num_elements, void *arg) {                      \
    type *a;                                                                   \
    type *b;                                                                   \
    type *c;                                                                   \
...
#define ac_sort_less_m(name, type)                                           \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b)) {                        \
    type *a;                                                                   \
    type *b;                                                                   \
...
#define ac_sort_less_arg_m(name, type)                                       \
  void name(type *base, size_t num_elements,                                   \
            bool (*less)(datatype * a, datatype * b, void *arg), void *arg) {  \
    type *a;                                                                   \
    type *b;                                                                   \
