...
Our application will keep track of where memory is allocated and can be printed by using the stla_dump_global_allocations.  Each allocation will be use a doubly-linked list node which can defined as...
```c
